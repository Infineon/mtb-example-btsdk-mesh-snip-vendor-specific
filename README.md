...
2. Run the application and refer to the Mesh Client Control user guide. Refer to Bluetooth SIG Mesh Specification: https://www.bluetooth.com/specifications/mesh-specifications
...
2. The default PUART baud rate is set in that location to 921600, except for BSPs that use the KitProg3 USB Serial bridge device.  Those BSPs default to 3M, and use 2 stop bits.

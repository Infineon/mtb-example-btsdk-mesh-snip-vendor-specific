...
## Overview
This app demonstrates the use of a SIG BLE mesh model as indicated by the name of the application.

## Instructions
To demonstrate the app, follow these steps:

1. Build and download the application to the WICED board
2. Run the application and refer to the Mesh Client Control user guide. Refer to BT SIG Mesh Specification: https://www.bluetooth.com/specifications/mesh-specifications
